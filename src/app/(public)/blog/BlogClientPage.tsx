...
export default function BlogClientPage({ blogs }: BlogClientPageProps) {
  ...
  useEffect(() => {
    const handleFocus = () => {
      // Revalidate the data when the user switches back to this tab
      router.refresh();
    };
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center pt-24">
         <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">No articles found yet.</h1>
            <p className="text-gray-500">Check back soon for latest insights!</p>
         </div>
      </div>
    );
  }

  const trendingArticle = blogs[0];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-full min-h-[400px] flex items-center justify-center lg:justify-end lg:pr-12">
               <div className="relative">
                 ...
                 >
                   <img 
                      src={trendingArticle.image || "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&q=80&w=800"}
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-text-body/80 pt-6">
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-[#B22222]/10 rounded-full border border-[#B22222]/20 flex items-center justify-center font-bold text-[#B22222]">
                    {trendingArticle.author.charAt(0)}
                  </div>
            ...
            {recentArticles.map((article, i) => (
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden">
                   {/* We use standard Img because background image optimization for external URLs requires config update and server restart sometimes */}
                  <img 
                    src={article.image || "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&q=80&w=800"}
                    alt={article.title}
